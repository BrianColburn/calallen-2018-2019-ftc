 ...
 */
public class JWheelManager implements WheelManager {
    private DcMotor[] mot;
     ...
     */
    public JWheelManager(DcMotor[] mot, double radius, double omega, double axle, double scale, final int ticks) {
        this.mot    = mot;
        this.radius = radius;
        this.theta  = 0;
        this.dist   = 0;
    ...
    public JWheelManager(Optional<DcMotor>[] mot, double v, double v1, double v2, int i, int i1) {
